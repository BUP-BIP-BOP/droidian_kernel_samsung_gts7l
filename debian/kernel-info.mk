...
DEVICE_FULL_NAME = Samsung Galaxy Tab S7
...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/gts7l_eur_open_halium_defconfig
...
# will be made.
#KERNEL_IMAGE_DTB = arch/arm64/boot/dts/vendor/qcom/kona-v2.1.dtb.reverse.dts
...
# If you leave this undefined, an attempt to find it automatically
# will be made.
#KERNEL_IMAGE_DTB_OVERLAY = arch/arm64/boot/dts/samsung/gts7l/kona-sec-gts7l-eur-overlay-r06.dtbo.reverse.dts
...
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2021-09-01
...
#BUILD_PATH = /buildd/sources/toolchain/llvm/bin
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, clang-android-9.0-r353983c, libncursesw5-dev, libncurses5-dev, schedtool, python-is-python3
